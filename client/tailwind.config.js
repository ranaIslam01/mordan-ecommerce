  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'modern-lg': '0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)',
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, var(--primary-600) 0%, var(--secondary-500) 50%, var(--accent-500) 100%)',
      ...
      keyframes: {
        ...
        glow: {
          'from': { boxShadow: '0 0 20px rgb(99 102 241 / 0.3)' },
          'to': { boxShadow: '0 0 30px rgb(99 102 241 / 0.5)' },
        },
        slideUp: {
          'from': {
            opacity: '0',
