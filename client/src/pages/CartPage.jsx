        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mx-auto w-32 h-32 xl:w-40 xl:h-40 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center mb-8 animate-scale-in">
              <svg
                className="w-16 h-16 xl:w-20 xl:h-20 text-gray-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            <div className="glass-effect rounded-3xl p-6 xl:p-8 backdrop-blur-xl border border-white/20 dark:border-gray-700/60 bg-white/80 dark:bg-gray-800/80">
              <div className="space-y-6">
                {cartItems.map((item, index) => (
                  <div
                    key={item._id}
                    className="group bg-white/60 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/50 dark:border-gray-700/70 hover:shadow-modern-lg transition-all duration-300 animate-slide-up"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <div className="flex flex-col sm:flex-row gap-6">
                      {/* Product Image */}
                      <div className="flex-shrink-0">
                        <div className="w-24 h-24 xl:w-32 xl:h-32 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 group-hover:scale-105 transition-transform duration-300">
                          <img
                            src={item.image}
                            alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:justify-between gap-4">
                          ...
                          <div className="flex flex-col items-end gap-4">
                            <div className="flex items-center bg-gray-100 dark:bg-gray-700/80 rounded-xl p-1">
                              <button
                                onClick={() =>
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 font-medium transition-colors duration-200"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
          ...
          <div className="lg:col-span-4">
            <div className="glass-effect rounded-3xl p-6 xl:p-8 backdrop-blur-xl border border-white/20 dark:border-gray-700/60 bg-white/80 dark:bg-gray-800/80 sticky top-8">
              ...
              <Button
                ...
                className="h-14 text-lg font-semibold shadow-glow-lg hover:shadow-glow-lg transition-all duration-300 mb-4 dark:bg-primary-500 dark:hover:bg-primary-600"
              >
