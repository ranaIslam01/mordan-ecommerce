        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-9">
            <div className="bg-white/90 dark:bg-gray-800/90 rounded-3xl p-6 xl:p-8 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl">
              ...
              {activeTab === "overview" && (
                <div>
                  <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-6 font-serif">
                    Account Overview
                  </h2>
                    ...
                    {loading ? (
                      ...
                      <div className="space-y-3">
                        {orders.slice(0, 3).map((order) => (
                          <div
                            key={order._id}
                            className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/70 rounded-xl"
                          >
              ...
              {activeTab === "orders" && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-50 font-serif">
                      My Orders
                    </h2>
                    <Link to="/myorders">
