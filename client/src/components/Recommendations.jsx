...
const Recommendations = ({ currentProduct = null, type = "general" }) => {
    ...
    switch (type) {
      ...
      case "recently_viewed":
        ...
        filteredProducts = mockProducts
          .filter((p) => recentlyViewed.includes(p._id))
          .slice(0, 4);
        break;
      case "trending":
  ...
  return (
    <section className="py-16 bg-gray-50 dark:bg-gray-900/90 transition-colors duration-300">
      <div className="container-responsive">
        {/* Header */}
        <div className="text-center mb-12 animate-slide-up">
          <h2 className="text-heading-xl text-gray-900 dark:text-white font-serif mb-4">
            {getSectionTitle()}
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {recommendations.map((product, index) => (
            <div
              key={product._id}
              className="animate-slide-up bg-white dark:bg-gray-800 rounded-2xl shadow-modern dark:shadow-2xl p-4"
        ...
        {userInfo && type === "general" && (
          <div className="mt-16 p-8 bg-white dark:bg-gray-800 rounded-3xl shadow-modern dark:shadow-2xl animate-slide-up">
            <div className="text-center">
              <h3 className="text-heading-md text-gray-900 dark:text-white mb-4">
                Improve Your Recommendations
              </h3>
              <p className="text-body-md text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
                Help us personalize your shopping experience by telling us about
                your preferences.
              </p>
