        ...
        <div className="flex justify-between items-center h-16 lg:h-20 xl:h-24">
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-3">
            ...
            <div className="relative p-2.5 lg:p-3 rounded-xl hover:bg-gradient-to-br hover:from-orange-50 hover:to-yellow-50 dark:hover:from-orange-900/20 dark:hover:to-yellow-900/20 transition-all duration-300 group border border-transparent hover:border-orange-200 dark:hover:border-orange-700/50 cursor-pointer">
              <svg
                className="w-5 h-5 lg:w-6 lg:h-6 text-gray-600 dark:text-gray-200 group-hover:text-orange-600 dark:group-hover:text-orange-300 transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
                <path
                  ...
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M15 17h5l-5-5v-5a5.99 5.99 0 00-6-6 5.99 5.99 0 00-6 6v5l-5 5h5m0 0v1a3 3 0 006 0v-1m-3-10h.01"
                />
              </svg>
            ...
            >
              <svg
                className="w-5 h-5 lg:w-6 lg:h-6 text-gray-600 dark:text-gray-200 group-hover:text-pink-600 dark:group-hover:text-pink-300 transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            >
              <svg
                className="w-5 h-5 lg:w-6 lg:h-6 text-gray-600 dark:text-gray-200 group-hover:text-blue-600 dark:group-hover:text-blue-300 transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {userInfo ? (
              ...
              >
                <button className="flex items-center gap-2 lg:gap-3 px-3 lg:px-4 py-2 lg:py-2.5 rounded-xl hover:bg-gradient-to-r hover:from-primary-50 hover:to-secondary-50 dark:hover:from-primary-900/20 dark:hover:to-secondary-900/20 transition-all duration-300 group border border-transparent hover:border-primary-200 dark:hover:border-primary-700/50">
                  <div className="relative">
                  ...
                  <svg
                    className="w-4 h-4 text-gray-400 group-hover:text-primary-500 transition-all duration-300 transform group-hover:rotate-180 hidden lg:block"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              <div className="flex items-center gap-2">
                <Link to="/login">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="px-4 lg:px-6 py-2 lg:py-2.5 text-sm lg:text-base font-semibold"
                  >
                    Sign In
                  </Button>
                </Link>
                <Link to="/register">
                  <Button
                    variant="primary"
                    size="sm"
                    className="px-4 lg:px-6 py-2 lg:py-2.5 text-sm lg:text-base font-semibold bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600 shadow-lg hover:shadow-xl"
                  >
                    Sign Up
                  </Button>
                </Link>
          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            >
              <div className="w-6 h-6 flex flex-col justify-center items-center">
                <span
                  className={`bg-gray-700 dark:bg-gray-100 block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm ${
                    isMobileMenuOpen
                ...
                ></span>
                <span
                  className={`bg-gray-700 dark:bg-gray-100 block transition-all duration-300 ease-out h-0.5 w-6 rounded-sm my-0.5 ${
      ...
      >
        <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-t border-gray-200/50 dark:border-gray-700/50">
          ...
          <div className="px-4 py-4 border-t border-gray-200/50 dark:border-gray-700/50">
            ...
            {/* Mobile Dark Mode Toggle (only visible in menu) */}
              ...
              <div className="space-y-3">
                ...
                >
                  <Button
                    variant="primary"
                    fullWidth
                    className="py-3 font-semibold bg-gradient-to-r from-primary-500 to-secondary-500 hover:from-primary-600 hover:to-secondary-600"
                  >
                    Sign Up
                  </Button>
                </Link>
